...
from backend.routes import user_controllers, calendar_controllers, authentication_controllers, dragon_controllers
...
app.register_blueprint(dragon_controllers.dragon_api_route)
